      ...
      <div className="container-custom">
        ...
        <div className="text-center mb-16" data-aos="fade-up">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Kumpulan portfolio dari berbagai program training, mentoring,
            kolaborasi, case study, dan tulisan yang telah saya kerjakan
          </p>
        ...
        {filteredItems.length > 0 && (
          <div className="text-center mt-12" data-aos="fade-up">
            <p className="text-gray-600">
              ...
              dari {portfolioStats.total} portfolio
            </p>
          </div>
        )}
        ...
        >
          <div className="bg-gradient-to-r from-primary-50 to-secondary-50 rounded-2xl p-8 md:p-12">
            ...
            <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
              Saya terbuka untuk diskusi mengenai training, mentoring, atau
              kolaborasi lainnya. Mari berdiskusi bagaimana kita bisa bekerja
              sama!
            </p>
            <a
              href="#contact"

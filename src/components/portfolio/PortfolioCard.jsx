...
const PortfolioCard = ({ item }) => {
  ...
  const categoryColor = categoryColors[primaryCategory] || 'bg-gray-100 text-gray-600';
  ...
  return (
    ...
    >
      ...
      <div className="p-6 flex flex-col flex-grow">
        {/* Category Badge */}
        <div className="mb-3">
          <span className={`inline-block px-2.5 py-1 rounded-md text-xs font-semibold ${categoryColor}`}>
            {categoryLabel}
          </span>
        </div>
        ...
        <div className="pt-4 border-t border-gray-100 flex items-center justify-between text-xs text-gray-500 font-medium">
          ...
          <div className="flex items-center gap-1.5">
            <span className="material-icons-round text-base">{getCategoryIcon()}</span>

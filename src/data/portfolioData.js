...
export const portfolioItems = [
  // Training & Case Study
  {
    ...
    image:
      "/dist/images/porto/Case Study - Training & Development Case Scenario.png",
  ...
  // Mentoring
  {
    ...
    image:
      "/dist/images/porto/Case Study - Learning & Development Case Scenario.png",
  ...
  // Tulisan - Self-Help
  {
    ...
    image:
      "/dist/images/porto/Self-Help - The 3 Conversations That Can Cost You Opportunities.png",
    link: "https://www.linkedin.com/pulse/3-conversations-can-cost-you-opportunities-lesson-from-rahmawati-2a8uc/",
    featured: false,
  },
  ...
  // Tulisan - Masters & LPDP
  {
    ...
    image:
      "/dist/images/porto/Masters & LPDP - Crafting Theory of Change for Your LPDP Essay.png",
  ...
  // Tulisan - Masters & LPDP
  {
    ...
    image:
      "/dist/images/porto/Masters & LPDP - 𝗠𝗲𝗻𝘂𝗹𝗶𝘀 𝗘𝘀𝗮𝗶 𝗟𝗣𝗗𝗣 𝗱𝗮𝗻 𝗠𝗼𝘁𝗶𝘃𝗮𝘁𝗶𝗼𝗻 𝗟𝗲𝘁𝘁𝗲𝗿 𝗱𝗲𝗻𝗴𝗮𝗻 𝗦𝗖𝗤𝗔.jpg",
  ...
  // Tulisan - Masters & LPDP
  {
    ...
    image:
      "/dist/images/porto/Masters & LPDP - 𝟱 𝗧𝗶𝗽𝘀 𝗠𝗲𝗻𝗴𝗮𝘁𝘂𝗿 𝗪𝗮𝗸𝘁𝘂 𝘂𝗻𝘁𝘂𝗸 𝗣𝗲𝗸𝗲𝗿𝗷𝗮 𝗙𝘂𝗹𝗹-𝗧𝗶𝗺𝗲 𝘆𝗮𝗻𝗴 𝗦𝗲𝗱𝗮𝗻𝗴 𝗠𝗲𝗺𝗽𝗲𝗿𝘀𝗶𝗮𝗽𝗸𝗮𝗻 𝗦𝟮.jpg",
  ...
  // Tulisan - Masters & LPDP
  {
    ...
    image:
      "/dist/images/porto/Masters & LPDP - Galau Resign atau Lanjut S2.jpg",
  ...
  // Tulisan - Learning
  {
    ...
    image:
      "/dist/images/porto/Learning - How Successful Corporate Innovation Training Look Like in the Age of AI.webp",
  ...
  // Tulisan - Learning
  {
    ...
    image:
      "/dist/images/porto/Learning - How TikTok Is Transforming Adult Learning to Foster Lifelong Learning.jpg",
  ...
  // Tulisan - Learning
  {
    ...
    image:
      "/dist/images/porto/Learning - Pertumbuhan Dua Arah pada Mentoring.png",
  ...
  // Tulisan - Learning
  {
    ...
    image:
      "/dist/images/porto/Learning - 𝗖𝗼𝗻𝗻𝗲𝗰𝘁𝗶𝘃𝗶𝘀𝗺 𝗧𝗵𝗲 𝗟𝗲𝗮𝗿𝗻𝗶𝗻𝗴 𝗦𝘁𝗿𝗮𝘁𝗲𝗴𝘆 𝗳𝗼𝗿 𝘁𝗵𝗲 𝗗𝗶𝗴𝗶𝘁𝗮𝗹 𝗔𝗴𝗲.webp",
...
export const portfolioStats = {
  ...
  training: portfolioItems.filter((item) => item.category.includes("training"))
    .length,
  mentoring: portfolioItems.filter((item) =>
    item.category.includes("mentoring")
  ).length,
  kolaborasi: portfolioItems.filter((item) =>
    item.category.includes("kolaborasi")
  ).length,
  casestudy: portfolioItems.filter((item) =>
    item.category.includes("casestudy")
  ).length,
  tulisan: portfolioItems.filter((item) => item.category.includes("tulisan"))
    .length,
